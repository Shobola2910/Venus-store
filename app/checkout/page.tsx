      ...
      <section className="container-main py-10">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-2 text-slate-600">
            Mijoz ma’lumotlari va to‘lov usuli shu yerda olinadi.
          </p>

          <form className="card mt-6 space-y-4 p-6">
            <div className="grid gap-4 md:grid-cols-2">
              <input className="input" placeholder="Ism" />
              <input className="input" placeholder="Telefon raqam" />
            </div>
            ...
            <div>
              ...
              <div className="grid gap-3 md:grid-cols-3">
                <button
                  type="button"
                  className="rounded-2xl border border-pink-200 bg-white px-4 py-3 text-left"
                >
                  Paynet ulash
                </button>
